...
# To use PostgreSQL, uncomment the PostgreSQL config and comment SQLite
...
if USE_POSTGRESQL:
    DATABASES = {
        'default': {
            ...
            'NAME': config('DATABASE_NAME', default='pizzashop_db'),
...
# Custom User Model (using built-in User with profile extension)
